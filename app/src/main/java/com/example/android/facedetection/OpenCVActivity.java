                ...
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    try {
                        ...
                        if (mJavaDetector.empty()) {
                            Log.e(TAG, "Failed to load cascade classifier at "+ mCascadeFile.getAbsolutePath());
                            mJavaDetector = null;
                        } else
                        ...
                        if (mJavaDetectorEye.empty()) {
                            Log.e(TAG, "Failed to load cascade classifier for eye at "+mCascadeFileEye.getAbsolutePath());
